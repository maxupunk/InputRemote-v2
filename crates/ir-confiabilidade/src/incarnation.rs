...
//! mexem na seguinte.
//!
//! Aqui mora a decisão, pura; o que a sessão faz com ela mora em `ir-session`.
//!
...
impl Incarnations {
    ...
    pub fn follow_peer(&mut self, epoch: Epoch) {
        self.forget_peer();
