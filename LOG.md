...
## 2026-09-09 — PoC-1: o spike da tela de bloqueio, pronto para rodar
...
([08, §2](docs/08-plano-de-implementacao.md)). Confirmado: `cargo xtask check` continua vendo
65 arquivos.

### O que o spike implementa

O fluxo de [05, §3.1](docs/05-windows.md), no menor tamanho que ainda responde a pergunta:
...
5. `CreateProcessAsUserW` em `WinSta0\Default`, **não** em `Winlogon`: o desktop seguro é
   alcançado de dentro, por thread ([00b, §4](docs/00-licoes-do-deskflow.md)).
